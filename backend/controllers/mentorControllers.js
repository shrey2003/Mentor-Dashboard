...
const getAssignedStudents = (req, res) => {
  ...
  db.query(checkMentorQuery, (err, result) => {
    ...
    const getStudentsQuery = `
      SELECT students.id, students.name, students.email, students.phone, students.evaluated_by, student_marks.ideation_marks, student_marks.execution_marks, student_marks.viva_marks, student_marks.rapidfire_marks, student_marks.total_marks
      FROM students
    ...
    db.query(checkStudentQuery, (err, result) => {
      ...
      db.query(checkMarkedQuery, (err, result) => {
        ...
        if (result.length > 0) {
          ...
          const addMarksQuery = `INSERT INTO student_marks (student_id, ideation_marks, execution_marks, viva_marks, rapidfire_marks) VALUES (${studentId}, ${
            ideation_marks | null
          }, ${execution_marks | null}, ${viva_marks | null}, ${
            rapidfire_marks | null
          })`;
